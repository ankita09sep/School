  ...
  var loadFile = function(event) {
    ...
    output.onload = function() {
      URL.revokeObjectURL(output.src)
              ...
              <input type="text" class="form-control" placeholder="Birth certificate no" id="birth_certificate" name="birth_certificate" onblur="generatepassword()"><input type="file" name="file_upload[0]"  />
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
                <label for="option">Category:</label></br>
              ...
              <input type="text" class="form-control" placeholder="Name of the last school Attended(if any)" id="last_school" name="last_school"><input type="file" name="file_upload[0]"  />
			  </div>
			  <div class="form-group">
              ...
              <input type="text" class="form-control"  placeholder="UID No" id="uid_no" name="uid_no"><input type="file" name="file_upload[0]"  />
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
                <label for="text">UID No:</label>
              <input type="text" class="form-control"  placeholder="UID No" id="uid_no1" name="uid_no1"><input type="file" name="file_upload[0]"  />
			  </div>
			  <div class="form-group">
